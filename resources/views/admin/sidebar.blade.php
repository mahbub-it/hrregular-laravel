        ...
        <div class="sidebar-menu " id="sideMenuScroll">
            <ul>
                ...
                <li class="accordionItem closeIt">
                    ...
                    <a class="nav-item text-lightest f-15 sidebar-text-color" href="notices.html" title="Notice Board">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li class="accordionItem closeIt">
                    ...
                    <a class="nav-item text-lightest f-15 sidebar-text-color accordionItemHeading " title="Biometric">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li class="accordionItem closeIt">
                    ...
                    <div class="accordionItemContent pb-2">
                        ...
                        <!-- COLLAPSE - INFORMATION -->
                        <a class="f-14 text-lightest" href="overtime-requests.html" title="Overtime Request">Overtime
                            Request
                        </a>
                        <!-- COLLAPSE - INFORMATION -->
                ...
                <li class="accordionItem closeIt">
                    ...
                    <a class="nav-item text-lightest f-15 sidebar-text-color accordionItemHeading " title="Performance">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-wallet" viewBox="0 0 16 16">
                ...
                <li class="accordionItem closeIt">
                    ...
                    <a class="nav-item text-lightest f-15 sidebar-text-color accordionItemHeading " title="Purchase">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-wallet" viewBox="0 0 16 16">
                            <path
                ...
                <li class="accordionItem closeIt">
                    ...
                    <a class="nav-item text-lightest f-15 sidebar-text-color accordionItemHeading " title="Webhooks">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-wallet" viewBox="0 0 16 16">
                ...
                <li class="accordionItem closeIt">
                    ...
                    <div class="accordionItemContent">
                        ...
                        <!-- COLLAPSE - INFORMATION -->
                        <a class="f-14 text-lightest" href="time-log-weekly-report.html" title="Weekly Timesheet">Weekly
                            Timesheet
                        </a>
                        ...
                        <!-- COLLAPSE - INFORMATION -->
                        <a class="f-14 text-lightest" href="income-expense-report.html" title="Income Vs Expense">Income
                            Vs Expense
                        </a>
                        ...
                        <!-- COLLAPSE - INFORMATION -->
                        <a class="f-14 text-lightest" href="attendance-report.html" title="Attendance Report">Attendance
                            Report
                        </a>
                        <!-- COLLAPSE - INFORMATION -->
