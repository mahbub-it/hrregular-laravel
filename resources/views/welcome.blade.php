    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Welcome to HR Regular</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">HR Regular is a comprehensive human resource
                    management
                    system designed to streamline HR processes and improve employee engagement.</p>
