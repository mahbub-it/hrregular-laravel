(function () {
    ...
    function ya(a) {
        this.next = function (b) {
            qa(a.a);
            a.a.b ? (b = wa(a, a.a.b.next, b, a.a.B)) : (a.a.B(b), (b = xa(a)));
            return b;
        };
        this.throw = function (b) {
            qa(a.a);
            a.a.b ? (b = wa(a, a.a.b["throw"], b, a.a.B)) : (ra(a.a, b), (b = xa(a)));
            return b;
        };
    ...
    (function () {
        ...
        var f = Node.prototype.cloneNode,
            ...
            jf = DocumentFragment.prototype.querySelectorAll,
            kf = (function () {
                if (!c) {
                    ...
                    a = a.cloneNode(!0);
                    return (
                        0 === a.content.childNodes.length || 0 === a.content.firstChild.content.childNodes.length || d
                    );
                }
            })();
        if (c) {
            var ca = document.implementation.createHTMLDocument("template"),
                Ec = !0,
                q = document.createElement("style");
            q.textContent = "template{display:none;}";
            var Fc = document.head;
            Fc.insertBefore(q, Fc.firstElementChild);
            a.prototype = Object.create(HTMLElement.prototype);
            var lf = !document.createElement("div").hasOwnProperty("innerHTML");
            a.R = function (b) {
                if (!b.content && b.namespaceURI === document.documentElement.namespaceURI) {
                    b.content = ca.createDocumentFragment();
                    for (var c; (c = b.firstChild);) m.call(b.content, c);
                    if (lf) b.__proto__ = a.prototype;
                    else if (
                ...
                l = function (b) {
                    Object.defineProperty(b, "innerHTML", {
                        ...
                        set: function (b) {
                            ...
                            ca.body.innerHTML = b;
                            for (a.a(ca); this.content.firstChild;) k.call(this.content, this.content.firstChild);
                            b = ca.body;
                ...
                D = function (a) {
                    Object.defineProperty(a, "outerHTML", {
                        ...
                        set: function (a) {
                            if (this.parentNode) {
                                ca.body.innerHTML = a;
                                for (a = this.ownerDocument.createDocumentFragment(); ca.body.firstChild;)
                                    m.call(a, ca.body.firstChild);
            ...
            var of = q(
                ...
                pf = q("style script xmp iframe noembed noframes plaintext noscript".split(" ")),
                pb = function (a, b) {
                    "template" === a.localName && (a = a.content);
                    for (var c = "", d = b ? b(a) : B.get.call(a), e = 0, f = d.length, g; e < f && (g = d[e]); e++) {
                        a: {
                            var h = g;
                            var k = a;
                            var m = b;
                            switch (h.nodeType) {
                                case Node.ELEMENT_NODE:
                                    for (var n = h.localName, l = "<" + n, p = h.attributes, A = 0; (k = p[A]); A++)
                                        l += " " + k.name + '="' + k.value.replace(mf, Gc) + '"';
                                    l += ">";
                                    h = of[n] ? l : l + pb(h, m) + "</" + n + ">";
                                    break a;
                                case Node.TEXT_NODE:
                                    h = h.data;
                                    h = k && pf[k.localName] ? h : h.replace(nf, Gc);
                                    break a;
        ...
        if (c || kf) {
            a.b = function (a, b) {
                var c = f.call(a, !1);
                this.R && this.R(c);
                b && (m.call(c.content, f.call(a.content, !0)), qb(c.content, a.content));
                return c;
            };
            var qb = function (c, d) {
                if (d.querySelectorAll && ((d = b(d, "template")), 0 !== d.length)) {
                    ...
                    for (var e = 0, f = c.length, g, h; e < f; e++)
                        (h = d[e]), (g = c[e]), a && a.R && a.R(h), n.call(g.parentNode, qf.call(h, !0), g);
                }
            },
                qf = (Node.prototype.cloneNode = function (b) {
                    if (!e && d && this instanceof DocumentFragment)
                        if (b) var c = rf.call(this.ownerDocument, this, !0);
                ...
                rf = (Document.prototype.importNode = function (c, d) {
                    d = d || !1;
    ...
    function Fa(a, b) {
        ...
        0 === a.J
            ...
            : ((a.Aa = !0),
                t.a(function () {
                    var c = 1 === a.J ? b.bb : b.cb;
                    if (null === c) (1 === a.J ? Ga : Ha)(b.va, a.A);
                    else {
                        try {
                            var d = c(a.A);
                        } catch (e) {
    ...
    function Ia(a) {
        ...
        for (var b = 0, c = a.V.length; b < c; b++) Fa(a, a.V[b]);
        a.V = null;
    }
    function Ja(a, b, c) {
    ...
    t.resolve = function (a) {
        return a && "object" === typeof a && a.constructor === t
            ? a
            : new t(function (b) {
                b(a);
            });
...
*/
    if (
        ...
        t.a = function (a) {
            La.push(a);
            Ka.textContent = 0 < Ka.textContent.length ? "" : "a";
        };
    }
    var Ma = {},
        Na = Object.create,
    ...
    function u(a, b) {
        b = void 0 === b ? {} : b;
        return { value: a, configurable: !!b.Ba, writable: !!b.kb, enumerable: !!b.e };
    }
    var Qa = void 0;
    try {
        Qa =
    ...
    function Sa(a) {
        a = String(a);
        for (var b = "", c = 0; Ra[a + b];) b = c += 1;
        Ra[a + b] = 1;
        var d = "Symbol(" + a + b + ")";
        Qa &&
            Pa(Object.prototype, d, {
                get: void 0,
                set: function (a) {
                    Pa(this, d, u(a, { Ba: !0, kb: !0 }));
                },
                configurable: !0,
                enumerable: !1,
            });
    ...
    function v(a) {
        ...
        a = void 0 === a ? "" : String(a);
        var b = Sa(a);
        return Qa ? Na(Ta, { xa: u(a), Na: u(b) }) : b;
    }
    Oa(v, {
        for: u(function (a) {
            a = String(a);
        ...
        keyFor: u(function (a) {
            if (Qa && (!a || "Symbol" !== a[v.toStringTag])) throw new TypeError("" + a + " is not a symbol");
            for (var b in Ma) if (Ma[b] === a) return Qa ? Ma[b].xa : Ma[b].substr(7, Ma[b].length - 8);
        }),
    });
    Oa(v, {
        Bb: u(v("hasInstance")),
        Cb: u(v("isConcatSpreadable")),
        ...
        split: u(v("split")),
        Fb: u(v("toPrimitive")),
        toStringTag: u(v("toStringTag")),
        unscopables: u(v("unscopables")),
    });
    Oa(Ta, {
        constructor: u(v),
        toString: u(function () {
        ...
        valueOf: u(function () {
            return "Symbol(" + this.xa + ")";
        }),
    });
    Qa && Pa(Ta, v.toStringTag, u("Symbol", { Ba: !0 }));
    var Ua = "function" === typeof Symbol ? Symbol : v; /*
...
*/
    if (!window.Symbol) {
        window.Symbol = Ua;
        var Va = window.Symbol.iterator;
        Array.prototype[Va] = function b() {
            var c,
                d = this;
            return za(b, function (b) {
                1 == b.a && (c = 0);
                if (3 != b.a) return c < d.length ? (b = sa(b, d[c])) : ((b.a = 0), (b = void 0)), b;
                c++;
                b.a = 2;
            });
        };
            ...
            return za(c, function (c) {
                1 == c.a &&
                    ((d = []),
                        ...
                        (f = 0));
                if (3 != c.a) return f < d.length ? (c = sa(c, d[f])) : ((c.a = 0), (c = void 0)), c;
                f++;
                c.a = 2;
            });
        };
            ...
            return za(d, function (d) {
                1 == d.a &&
                    ((e = []),
                        ...
                        (g = 0));
                if (3 != d.a) return g < e.length ? (d = sa(d, e[g])) : ((d.a = 0), (d = void 0)), d;
                g++;
                d.a = 2;
            });
        };
        String.prototype[Va] = function e() {
            ...
            return za(e, function (e) {
                1 == e.a && (f = 0);
                if (3 != e.a) return f < g.length ? (e = sa(e, g[f])) : ((e.a = 0), (e = void 0)), e;
                f++;
                e.a = 2;
            });
        };
...
*/
    ...
    var Wa = document.querySelector('script[src*="webcomponents-bundle"]'),
        Xa = /wc-(.+)/,
        w = {};
    if (!w.noOpts) {
        location.search
            ...
            .forEach(function (a) {
                a = a.split("=");
                var b;
                a[0] && (b = a[0].match(Xa)) && (w[b[1]] = a[1] || !0);
            });
        if (Wa) for (var Ya = 0, Za; (Za = Wa.attributes[Ya]); Ya++) "src" !== Za.name && (w[Za.name] = Za.value || !0);
    ...
    var ab = w.shadydom;
    ab && ((window.ShadyDOM = window.ShadyDOM || {}), (window.ShadyDOM.force = ab));
    var bb = w.register || w.ce;
    bb && window.customElements && (window.customElements.forcePolyfill = bb); /*
...
*/
    function cb() {
        this.Fa = this.root = null;
        this.fa = !1;
        this.N = this.ba = this.qa = this.assignedSlot = this.assignedNodes = this.T = null;
        this.childNodes =
            this.nextSibling =
    ...
    z.Ya = !(!Element.prototype.attachShadow || !Node.prototype.getRootNode);
    var db = Object.getOwnPropertyDescriptor(Node.prototype, "firstChild");
    z.K = !!(db && db.configurable && db.get);
    z.ta = z.force || !z.Ya;
    var eb = navigator.userAgent.match("Trident"),
        fb = navigator.userAgent.match("Edge");
    void 0 === z.Ha && (z.Ha = z.K && (eb || fb));
    function gb(a) {
        return (a = y(a)) && void 0 !== a.firstChild;
    }
    function C(a) {
        return "ShadyRoot" === a.Qa;
    }
    function hb(a) {
        a = a.getRootNode();
        if (C(a)) return a;
    ...
    var ib = Element.prototype,
        jb =
            ib.matches ||
            ib.matchesSelector ||
            ib.mozMatchesSelector ||
            ib.msMatchesSelector ||
            ib.oMatchesSelector ||
            ib.webkitMatchesSelector;
    function kb(a, b) {
        if (a && b)
    ...
    function Ab() {
        yb = !1;
        for (var a = !!xb.length; xb.length;) xb.shift()();
        return a;
    }
    Ab.list = xb;
    function Bb() {
    ...
    function Eb(a) {
        var b = a && a.P;
        b && (b.ea.delete(a.Oa), b.ea.size || (x(a.Ra).T = null));
    }
    function Fb(a, b) {
        var c = b.getRootNode();
        return a
            .map(function (a) {
                ...
                if (b && a.addedNodes) {
                    if (
                        ...
                        return (
                            (a = Object.create(a)),
                            Object.defineProperty(a, "addedNodes", { value: b, configurable: !0 }),
                            a
                        );
                } else if (b) return a;
            })
    ...
    var Gb = Element.prototype.insertBefore,
        ...
        E = {};
    E.appendChild = Element.prototype.appendChild;
    E.insertBefore = Gb;
    E.replaceChild = Hb;
    E.removeChild = Ib;
    E.setAttribute = Jb;
    E.removeAttribute = Kb;
    E.cloneNode = Lb;
    E.importNode = Mb;
    E.addEventListener = Nb;
    E.removeEventListener = Ob;
    E.lb = Pb;
    E.mb = Qb;
    E.dispatchEvent = Rb;
    E.contains = Sb;
        ...
        for (var c = "", d = b ? b(a) : a.childNodes, e = 0, f = d.length, g; e < f && (g = d[e]); e++) {
            a: {
                ...
                switch (h.nodeType) {
                    ...
                    case Node.TEXT_NODE:
                        h = h.data;
                        h = k && ec[k.localName] ? h : h.replace(ac, bc);
                        break a;
                    case Node.COMMENT_NODE:
                        h = "\x3c!--" + h.data + "--\x3e";
                        break a;
    ...
    var hc = z.K,
        ic = [Node.prototype, Element.prototype, HTMLElement.prototype];
    function J(a) {
        var b;
        a: {
    ...
    var K = hc
        ? {
            ...
            previousSibling: J("previousSibling"),
            nextSibling: J("nextSibling"),
            childNodes: J("childNodes"),
            parentElement: J("parentElement"),
            previousElementSibling: J("previousElementSibling"),
            nextElementSibling: J("nextElementSibling"),
        ...
        lc = {
            ...
            children: function (a) {
                switch (a.nodeType) {
                    case Node.DOCUMENT_FRAGMENT_NODE:
                        return jc.children.get.call(a);
                    case Node.DOCUMENT_NODE:
                        return kc.children.get.call(a);
                    default:
            ...
            firstElementChild: function (a) {
                switch (a.nodeType) {
                    case Node.DOCUMENT_FRAGMENT_NODE:
                        return jc.firstElementChild.get.call(a);
                    case Node.DOCUMENT_NODE:
                        return kc.firstElementChild.get.call(a);
                    default:
            ...
            lastElementChild: function (a) {
                switch (a.nodeType) {
                    case Node.DOCUMENT_FRAGMENT_NODE:
                        return jc.lastElementChild.get.call(a);
                    case Node.DOCUMENT_NODE:
                        return kc.lastElementChild.get.call(a);
                    default:
    ...
    var nc = z.K,
        ...
        uc = {
                    ...
                    switch (this.nodeType) {
                        ...
                        case Node.DOCUMENT_FRAGMENT_NODE:
                            if (!gb(this) && nc) {
                                ...
                                (b != this.lastChild || (b && b.nodeType != Node.TEXT_NODE)) && mc(this);
                                lc.Ea.textContent.set.call(this, a);
                            } else
                                mc(this),
            ...
            innerHTML: {
                ...
                set: function (a) {
                    ...
                    c =
                        this.namespaceURI && this.namespaceURI !== oc.namespaceURI
                            ? oc.createElementNS(this.namespaceURI, c)
                            : oc.createElement(c);
                    nc ? lc.Ea.innerHTML.set.call(c, a) : (c.innerHTML = a);
        ...
        wc = {
            activeElement: {
                get: function () {
                    var a = rc && rc.get ? rc.get.call(document) : z.K ? void 0 : document.activeElement;
                    if (a && a.nodeType) {
                        var b = !!C(this);
                        if (this === document || (b && this.host !== a && E.contains.call(this.host, a))) {
                            for (b = hb(a); b && b !== this;) (a = b.host), (b = hb(a));
    ...
    var Ac = z.K
        ...
        : function (a) {
            var b = x(a);
            b.ya || ((b.ya = !0), M(a, sc, !0), M(a, tc, !0));
        },
        Bc = z.K
            ? function () { }
            : function (a) {
                x(a).Ja || (M(a, uc, !0), M(a, vc, !0));
            };
    var Cc = L.childNodes;
    function Dc(a, b, c) {
        Ac(a);
    ...
    function Jc(a, b, c) {
        ...
        if (c) {
            var d = y(c);
            d = d && d.parentNode;
            if ((void 0 !== d && d !== a) || (void 0 === d && Ic(c) !== a))
                throw Error(
                    "Failed to execute 'insertBefore' on 'Node': The node before which the new node is to be inserted is not a child of this node."
                );
        }
        if (c === b) return b;
        b.parentNode && Kc(b.parentNode, b);
        var e, f;
        if (!b.__noInsertionPoint) {
            if ((f = e = hb(a))) {
                var g;
                "slot" === b.localName ? (g = [b]) : b.querySelectorAll && (g = b.querySelectorAll("slot"));
            ...
            f &&
                ((g = e),
                    ...
                    (g.m = g.m || []),
                    (g.v = g.v || {}),
                    g.a.push.apply(g.a, d instanceof Array ? d : Aa(ja(d))));
        }
        ("slot" === a.localName || f) && (e = e || hb(a)) && Lc(e);
        if (gb(a)) {
            e = c;
            Bc(a);
            f = x(a);
            ...
            if (b.nodeType === Node.DOCUMENT_FRAGMENT_NODE) {
                f = b.childNodes;
                for (g = 0; g < f.length; g++) Dc(f[g], a, e);
                e = x(b);
        ...
        h || ((h = C(a) ? a.host : a), c ? ((c = Nc(c)), E.insertBefore.call(h, b, c)) : E.appendChild.call(h, b));
        Oc(a, b);
        return b;
    }
    function Kc(a, b) {
        ...
        k ||
            ((k = C(a) ? a.host : a), ((!d.root && "slot" !== b.localName) || k === Ic(b)) && E.removeChild.call(k, b));
        Oc(a, null, b);
        return b;
    }
    function Pc(a) {
        ...
        if (b && void 0 !== b.W) {
            b = a.childNodes;
            for (var c = 0, d = b.length, e; c < d && (e = b[c]); c++) Pc(e);
        }
        if ((a = y(a))) a.W = void 0;
    }
    function Nc(a) {
        var b = a;
        a && "slot" === a.localName && (b = (b = (b = y(a)) && b.N) && b.length ? b[0] : Nc(a.nextSibling));
        return b;
    }
    function Mc(a) {
    ...
    function Tc(a, b) {
        if ("slot" === b) (a = a.parentNode), Mc(a) && Lc(y(a).root);
        else if ("slot" === a.localName && "name" === b && (b = hb(a))) {
            if (b.m) {
                var c = a.Ma,
                    d = Uc(a);
                if (d !== c) {
    ...
    function Oc(a, b, c) {
        if ((a = (a = y(a)) && a.T)) b && a.addedNodes.push(b), c && a.removedNodes.push(c), Cb(a);
    }
    function Wc(a) {
        if (a && a.nodeType) {
            var b = x(a),
            ...
            void 0 === c &&
                (C(a)
                    ? ((c = a), (b.W = c))
                    : ((c = (c = a.parentNode) ? Wc(c) : a),
                        E.contains.call(document.documentElement, a) && (b.W = c)));
            return c;
        }
    }
    function Xc(a, b, c) {
        var d = [];
        Yc(a.childNodes, b, c, d);
        return d;
    }
    function Yc(a, b, c, d) {
        for (var e = 0, f = a.length, g; e < f && (g = a[e]); e++) {
            ...
            if ((h = g.nodeType === Node.ELEMENT_NODE)) {
                ...
                var k = b,
                    ...
                    p = k(h);
                p && n.push(h);
                m && m(p) ? (h = p) : (Yc(h.childNodes, k, m, n), (h = void 0));
            }
            if (h) break;
        }
    }
    ...
    function $c(a, b, c) {
        ...
        Zc && "class" === b ? Zc.setElementClass(a, c) : (E.setAttribute.call(a, b, c), Tc(a, b));
    }
    function ad(a, b) {
        if (a.ownerDocument !== document || "template" === a.localName) return E.importNode.call(document, a, b);
        var c = E.importNode.call(document, a, !1);
        if (b) {
            a = a.childNodes;
            b = 0;
            for (var d; b < a.length; b++) (d = ad(a[b], !0)), c.appendChild(d);
        }
        return c;
    }
    ...
    var hd = {
        get composed() {
            void 0 === this.Z && (cd ? (this.Z = cd(this)) : !1 !== this.isTrusted && (this.Z = dd[this.type]));
            return this.Z || !1;
        },
        composedPath: function () {
            this.wa || (this.wa = fd(this.__target, this.composed));
            return this.wa;
        },
        get target() {
            return gd(this.currentTarget, this.composedPath());
        },
        get relatedTarget() {
            if (!this.ka) return null;
            this.za || (this.za = fd(this.ka, !0));
            return gd(this.currentTarget, this.za);
        },
    ...
    var jd = { focus: !0, blur: !0 };
    function kd(a) {
        return a.__target !== a.target || a.ka !== a.relatedTarget;
    }
    function ld(a, b, c) {
        if ((c = b.__handlers && b.__handlers[a.type] && b.__handlers[a.type][c]))
            for (var d = 0, e; (e = c[d]) && (!kd(a) || a.target !== a.relatedTarget) && (e.call(b, a), !a.Ia); d++);
    }
    function md(a) {
        ...
        for (c = 0; c < b.length; c++) {
            ...
            var f = y(d);
            f = f && f.root;
            if (0 === c || (f && f === e)) if ((ld(a, d, "bubble"), d !== window && (e = d.getRootNode()), a.ja)) break;
        }
    }
        ...
        if (b) {
            ...
            if ("function" === d || "object" === d)
                if ("object" !== d || (b.handleEvent && "function" === typeof b.handleEvent)) {
                    var e = this instanceof Window ? E.lb : E.addEventListener;
                    if (ed[a]) return e.call(this, a, b, c);
                    ...
                    m = function (e) {
                        ...
                        if (!C(k) || -1 != e.composedPath().indexOf(k))
                            if (e.composed || -1 < e.composedPath().indexOf(k))
                                if (kd(e) && e.target === e.relatedTarget)
                    ...
                    b[bd].push({ node: k, type: a, capture: f, once: g, passive: h, nb: m });
                    jd[a]
                        ? ((this.__handlers = this.__handlers || {}),
                            (this.__handlers[a] = this.__handlers[a] || { capture: [], bubble: [] }),
                            this.__handlers[a][f ? "capture" : "bubble"].push(m))
                        : e.call(this, a, m, c);
                }
        }
    }
    function qd(a, b, c) {
        if (b) {
            var d = this instanceof Window ? E.mb : E.removeEventListener;
            if (ed[a]) return d.call(this, a, b, c);
            if (c && "object" === typeof c) {
                var e = !!c.capture;
                var f = !!c.once;
                var g = !!c.passive;
            ...
            m && ((f = nd(m, h, a, e, f, g)), -1 < f && ((k = m.splice(f, 1)[0].nb), m.length || (b[bd] = void 0)));
            d.call(this, a, k || b, c);
            k &&
                jd[a] &&
                this.__handlers &&
    ...
    function vd() {
        window.Event = sd;
        window.CustomEvent = td;
        window.MouseEvent = ud;
        rd();
        if (!cd && Object.getOwnPropertyDescriptor(Event.prototype, "isTrusted")) {
            var a = function () {
    ...
    function xd(a, b, c, d) {
        ...
        if (b == a.length && d == c.length) {
            h = a.length;
            for (var m = c.length, n = 0; n < k - g && yd(a[--h], c[--m]);) n++;
            h = n;
        }
        e += g;
        f += g;
        ...
        if (e == b) {
            for (b = wd(e, 0); f < d;) b.X.push(c[f++]);
            return [b];
        }
        if (f == d) return [wd(e, b - e)];
        k = e;
        g = f;
        d = d - g + 1;
        h = b - k + 1;
    ...
    function zc(a, b, c) {
        if (a !== Ad) throw new TypeError("Illegal constructor");
        this.Qa = "ShadyRoot";
        this.host = b;
        this.c = c && c.mode;
        Hc(b);
    ...
    zc.prototype._renderRoot = function () {
        ...
        if (this.m) {
            ...
            for (c = this.host.firstChild; c; c = c.nextSibling) Fd(this, c);
            for (b = 0; b < this.m.length; b++) {
                c = this.m[b];
                e = y(c);
                if (!e.assignedNodes.length) for (d = c.firstChild; d; d = d.nextSibling) Fd(this, d, c);
                (d = (d = y(c.parentNode)) && d.root) && Sc(d) && d._renderRoot();
                Gd(this, e.N, e.assignedNodes);
                if ((d = e.qa)) {
                    for (f = 0; f < d.length; f++) y(d[f]).ba = null;
                    e.qa = null;
                    d.length > e.assignedNodes.length && (e.fa = !0);
                }
                e.fa && ((e.fa = !1), Hd(this, c));
            }
            b = this.m;
            c = [];
            ...
            for (b = 0; b < c.length; b++) {
                ...
                e = void 0;
                g = zd(d);
                h = xd(f, f.length, g, g.length);
                for (var m = (k = 0); k < h.length && (e = h[k]); k++) {
                    for (var n = 0, p; n < e.X.length && (p = e.X[n]); n++)
                        Rc(p) === d && E.removeChild.call(d, p), g.splice(e.index + m, 1);
                    m -= e.da;
                }
                for (m = 0; m < h.length && (e = h[m]); m++)
                    for (k = g[e.index], n = e.index; n < e.index + e.da; n++)
                        (p = f[n]), E.insertBefore.call(d, p, k), g.splice(n, 0, p);
            }
        }
        if (!this.b)
            for (p = this.host.childNodes, c = 0, b = p.length; c < b; c++)
                (e = p[c]),
                    (d = y(e)),
                    Rc(e) !== this.host ||
                    ("slot" !== e.localName && d.assignedSlot) ||
                    E.removeChild.call(this.host, e);
        this.b = !0;
        Bd = a;
        Cd && Cd();
    };
    function Fd(a, b, c) {
        var d = x(b),
            e = d.ba;
        d.ba = null;
        c || (c = (a = a.v[b.slot || "__catchall"]) && a[0]);
        c ? (x(c).assignedNodes.push(b), (d.assignedSlot = c)) : (d.assignedSlot = void 0);
        e !== d.assignedSlot && d.assignedSlot && (x(d.assignedSlot).fa = !0);
    }
    function Gd(a, b, c) {
    ...
    function Hd(a, b) {
        E.dispatchEvent.call(b, new Event("slotchange"));
        b = y(b);
        b.assignedSlot && Hd(a, b.assignedSlot);
    }
    function Qc(a) {
        if (a.a && a.a.length) {
            for (var b = a.a, c, d = 0; d < b.length; d++) {
                ...
                Hc(e.parentNode);
                var f = Uc(e);
                a.v[f] ? ((c = c || {}), (c[f] = !0), a.v[f].push(e)) : (a.v[f] = [e]);
                a.m.push(e);
            }
            if (c) for (var g in c) a.v[g] = Vc(a.v[g]);
            a.a = [];
        }
    }
    function Uc(a) {
    ...
    function Vc(a) {
        return a.sort(function (a, c) {
            a = Dd(a);
            for (var b = Dd(c), e = 0; e < a.length; e++) {
                c = a[e];
                var f = b[e];
    ...
    if (window.customElements && z.ta) {
        ...
        var Jd = function (a, b, c) {
            var d = 0,
                e = "__isConnected" + d++;
            if (b || c)
                (a.prototype.connectedCallback = a.prototype.Ka =
                    function () {
                        Bd ? Id.set(this, !0) : this[e] || ((this[e] = !0), b && b.call(this));
                    }),
                    (a.prototype.disconnectedCallback = a.prototype.La =
                        function () {
                            Bd
                                ? this.isConnected || Id.set(this, !1)
        ...
        Object.defineProperty(window.CustomElementRegistry.prototype, "define", {
            value: function (a, b) {
                ...
                define.call(window.customElements, a, Jd(b, c, d));
    ...
    var Ld = { addEventListener: od.bind(window), removeEventListener: qd.bind(window) },
        Md = {
            ...
            cloneNode: function (a) {
                if ("template" == this.localName) var b = E.cloneNode.call(this, a);
                else if (((b = E.cloneNode.call(this, !1)), a && b.nodeType !== Node.ATTRIBUTE_NODE)) {
                    a = this.childNodes;
            ...
            dispatchEvent: function (a) {
                Ab();
                return E.dispatchEvent.call(this, a);
            },
        };
    Object.defineProperties(Md, {
        isConnected: {
            get: function () {
                if (qc && qc.call(this)) return !0;
                if (this.nodeType == Node.DOCUMENT_FRAGMENT_NODE) return !1;
                var a = this.ownerDocument;
                if (ub) {
                    if (E.contains.call(a, this)) return !0;
                } else if (a.documentElement && E.contains.call(a.documentElement, this)) return !0;
                for (a = this; a && !(a instanceof Document);) a = a.parentNode || (C(a) ? a.host : void 0);
    ...
    var Nd = {
        ...
        Od = {
            ...
            querySelectorAll: function (a, b) {
                if (b) {
                    b = Array.prototype.slice.call(E.querySelectorAll.call(this, a));
    ...
    Object.defineProperties(Rd, { _activeElement: wc.activeElement });
    for (
        var Sd = HTMLElement.prototype.blur,
        Td = {
            blur: function () {
                var a = y(this);
                (a = (a = a && a.root) && a.activeElement) ? a.blur() : Sd.call(this);
            },
        },
        Ud = {},
        Vd = ja(Object.getOwnPropertyNames(Document.prototype)),
        Wd = Vd.next();
        !Wd.done;
        Ud = { H: Ud.H }, Wd = Vd.next()
    )
        (Ud.H = Wd.value),
            "on" === Ud.H.substring(0, 2) &&
            Object.defineProperty(Td, Ud.H, {
                set: (function (a) {
                    return function (b) {
                        var c = x(this),
                            d = a.H.substring(2);
    ...
    if (z.ta) {
        ...
        N(zc.prototype, Xd);
        N(window.Node.prototype, Md);
        N(window.Window.prototype, Ld);
        N(window.Text.prototype, Nd);
        N(window.DocumentFragment.prototype, Od);
        N(window.Element.prototype, Qd);
        N(window.Document.prototype, Rd);
        window.HTMLSlotElement && N(window.HTMLSlotElement.prototype, Pd);
        N(Yd.prototype, Td);
        z.K &&
            (xc(window.Node.prototype),
                xc(window.Text.prototype),
                xc(window.DocumentFragment.prototype),
                xc(window.Element.prototype),
                xc(Yd.prototype),
                xc(window.Document.prototype),
                window.HTMLSlotElement && xc(window.HTMLSlotElement.prototype));
        yc();
        window.ShadowRoot = zc;
    }
    var Zd = new Set(
            ...
            if (d.nodeType === Node.ELEMENT_NODE) {
                ...
                if ("link" === f && "import" === e.getAttribute("rel")) {
                    ...
                    if (d instanceof Node && !c.has(d))
                        for (c.add(d), d = d.firstChild; d; d = d.nextSibling) be(d, b, c);
                    d = ae(a, e);
                    continue;
                } else if ("template" === f) {
                    d = ae(a, e);
    ...
    function Q(a, b) {
        ...
        for (b = 0; b < c.length; b++) {
            var d = c[b];
            1 === d.__CE_state ? a.connectedCallback(d) : ge(a, d);
        }
    }
    function R(a, b) {
        var c = [];
    ...
    he.prototype.b = function (a) {
        ...
        ("interactive" !== b && "complete" !== b) || ie(this);
        for (b = 0; b < a.length; b++) for (var c = a[b].addedNodes, d = 0; d < c.length; d++) S(this.w, c[d]);
    };
    function je() {
        var a = this;
    ...
    r.define = function (a, b) {
        ...
        if (this.w.a.get(a)) throw Error("A custom element with name '" + a + "' has already been defined.");
        if (this.na) throw Error("A custom element is already being defined.");
        this.na = !0;
        try {
            var d = function (a) {
                var b = e[a];
    ...
    function ke(a) {
        if (!1 !== a.aa) {
            a.aa = !1;
            for (var b = a.pa, c = [], d = new Map(), e = 0; e < b.length; e++) d.set(b[e].localName, []);
            S(a.w, document, {
                ia: function (b) {
                    if (void 0 === b.__CE_state) {
                        var e = b.localName,
                            f = d.get(e);
                        f ? f.push(b) : a.w.a.get(e) && c.push(b);
                    }
                },
            });
            for (e = 0; e < c.length; e++) ge(a.w, c[e]);
            for (; 0 < b.length;) {
                var f = b.shift();
                e = f.localName;
                f = d.get(f.localName);
                for (var g = 0; g < f.length; g++) ge(a.w, f[g]);
                (e = a.sa.get(e)) && e.resolve(void 0);
            }
        }
    }
    r.get = function (a) {
        if ((a = this.w.a.get(a))) return a.constructor;
    };
    r.whenDefined = function (a) {
    ...
    T.prototype.upgrade = T.prototype.ia;
    T.prototype.get = T.prototype.get;
    T.prototype.whenDefined = T.prototype.whenDefined;
    T.prototype.polyfillWrapFlushCallback = T.prototype.eb;
    var le = window.Document.prototype.createElement,
        ...
        Re = window.HTMLElement.prototype.insertAdjacentHTML;
    var Se = new (function () { })();
    function Te() {
        var a = Ue;
        window.HTMLElement = (function () {
            function b() {
                ...
                if (0 === e.length)
                    return (
                        (e = le.call(document, d.localName)),
    ...
    function Ve(a, b, c) {
        function d(b) {
            return function (c) {
                ...
                if (O(this)) for (d = 0; d < e.length; d++) (f = e[d]), f instanceof Element && Q(a, f);
            };
        }
    ...
    function We() {
        ...
        P(Document.prototype, "importNode", function (b, c) {
            b = ne.call(this, b, c);
            this.__CE_hasRegistry ? S(a, b) : fe(a, b);
            return b;
        });
        ...
        Ve(a, Document.prototype, { ha: oe, append: pe });
    }
    function Xe() {
        function a(a, d) {
            Object.defineProperty(a, "textContent", {
                ...
                set: function (a) {
                    if (this.nodeType === Node.TEXT_NODE) d.set.call(this, a);
                        ...
                        d.set.call(this, a);
                        if (c) for (a = 0; a < c.length; a++) R(b, c[a]);
                    }
                },
            });
        }
        var b = Ue;
        P(Node.prototype, "insertBefore", function (a, d) {
            if (a instanceof DocumentFragment) {
                var c = Array.prototype.slice.apply(a.childNodes);
                a = ue.call(this, a, d);
                if (O(this)) for (d = 0; d < c.length; d++) Q(b, c[d]);
                return a;
            }
            c = O(a);
            d = ue.call(this, a, d);
        ...
        P(Node.prototype, "appendChild", function (a) {
            if (a instanceof DocumentFragment) {
                var c = Array.prototype.slice.apply(a.childNodes);
                a = te.call(this, a);
                if (O(this)) for (var e = 0; e < c.length; e++) Q(b, c[e]);
                return a;
            }
            c = O(a);
            e = te.call(this, a);
        ...
        P(Node.prototype, "cloneNode", function (a) {
            a = se.call(this, a);
            this.ownerDocument.__CE_hasRegistry ? S(b, a) : fe(b, a);
            return a;
        });
        ...
        P(Node.prototype, "replaceChild", function (a, d) {
            if (a instanceof DocumentFragment) {
                var c = Array.prototype.slice.apply(a.childNodes);
                a = we.call(this, a, d);
                if (O(this)) for (R(b, d), d = 0; d < c.length; d++) Q(b, c[d]);
                return a;
            }
            c = O(a);
            var f = we.call(this, a, d),
                g = O(this);
            g && R(b, d);
            c && R(b, a);
            g && Q(b, a);
        ...
        xe && xe.get
            ...
            : ee(b, function (b) {
                a(b, {
                    ...
                    set: function (a) {
                        for (; this.firstChild;) ve.call(this, this.firstChild);
    ...
    function Ye(a) {
        function b(b) {
            return function (c) {
                ...
                if (O(this)) for (d = 0; d < e.length; d++) (h = e[d]), h instanceof Element && Q(a, h);
            };
        }
        var c = Element.prototype;
        void 0 !== Ke && (c.before = b(Ke));
        void 0 !== Ke && (c.after = b(Le));
        void 0 !== Me &&
            P(c, "replaceWith", function (b) {
                ...
                if (h) for (R(a, this), c = 0; c < d.length; c++) (g = d[c]), g instanceof Element && Q(a, g);
            });
        void 0 !== Ne &&
            P(c, "remove", function () {
                var b = O(this);
    ...
    function Ze() {
        function a(a, b) {
            Object.defineProperty(a, "innerHTML", {
                ...
                set: function (a) {
                    ...
                    this.ownerDocument.__CE_hasRegistry ? S(d, this) : fe(d, this);
                    return a;
                },
            });
        }
        ...
        ze && ze.get
            ? a(Element.prototype, ze)
            : Pe && Pe.get
                ? a(HTMLElement.prototype, Pe)
                : ee(d, function (b) {
                    a(b, {
                        enumerable: !0,
                        configurable: !0,
                        ...
                        set: function (a) {
                            var b = "template" === this.localName,
                                ...
                                d = me.call(document, this.namespaceURI, this.localName);
                            for (d.innerHTML = a; 0 < c.childNodes.length;) ve.call(c, c.childNodes[0]);
                            for (a = b ? d.content : d; 0 < a.childNodes.length;) te.call(c, a.childNodes[0]);
                        },
                    });
                });
        P(Element.prototype, "setAttribute", function (a, b) {
            if (1 !== this.__CE_state) return Be.call(this, a, b);
            var c = Ae.call(this, a);
            Be.call(this, a, b);
            b = Ae.call(this, a);
            d.attributeChangedCallback(this, a, c, b, null);
        });
        P(Element.prototype, "setAttributeNS", function (a, b, c) {
            if (1 !== this.__CE_state) return Ee.call(this, a, b, c);
            var e = De.call(this, a, b);
            Ee.call(this, a, b, c);
            c = De.call(this, a, b);
            d.attributeChangedCallback(this, b, e, c, a);
        });
        P(Element.prototype, "removeAttribute", function (a) {
            if (1 !== this.__CE_state) return Ce.call(this, a);
            var b = Ae.call(this, a);
            Ce.call(this, a);
            null !== b && d.attributeChangedCallback(this, a, b, null, null);
        });
        P(Element.prototype, "removeAttributeNS", function (a, b) {
            if (1 !== this.__CE_state) return Fe.call(this, a, b);
            var c = De.call(this, a, b);
            Fe.call(this, a, b);
            var e = De.call(this, a, b);
            c !== e && d.attributeChangedCallback(this, b, c, e, a);
        });
        Qe
            ? b(HTMLElement.prototype, Qe)
            : Ge
                ? b(Element.prototype, Ge)
                : console.warn("Custom Elements: `Element#insertAdjacentElement` was not patched.");
        Re
            ? c(HTMLElement.prototype, Re)
            : He
                ? c(Element.prototype, He)
                : console.warn("Custom Elements: `Element#insertAdjacentHTML` was not patched.");
        Ve(d, Element.prototype, { ha: Ie, append: Je });
        Ye(d);
    }
    var $e = window.customElements;
    if (!$e || $e.forcePolyfill || "function" != typeof $e.define || "function" != typeof $e.get) {
        var Ue = new ce();
        Te();
        We();
        Ve(Ue, DocumentFragment.prototype, { ha: qe, append: re });
        Xe();
        Ze();
        document.__CE_hasRegistry = !0;
        var customElements = new T(Ue);
        ...
        a.parent &&
            ((c = b.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1)),
                ...
                a.atRule
                    ? 0 === c.indexOf("@media")
                        ? (a.type = hf)
                        : c.match(sf) && ((a.type = tf), (a.keyframesName = a.selector.split(gf).pop()))
                    : (a.type = 0 === c.indexOf("--") ? uf : vf));
        if ((c = a.rules)) for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) ef(f, b);
        return a;
    }
    function ff(a) {
    ...
    function wf(a, b, c) {
        ...
        if (a.cssText || a.rules) {
            ...
            if (f) {
                f = 0;
                for (var g = e.length, h; f < g && (h = e[f]); f++) d = wf(h, b, d);
            } else
                b
                    ? (b = a.cssText)
                    : ((b = a.cssText),
                        (b = b.replace(xf, "").replace(yf, "")),
                        (b = b.replace(zf, "").replace(Af, ""))),
                    (d = b.trim()) && (d = "  " + d + "\n");
        }
    ...
    window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss
        ? (Bf = window.ShadyCSS.nativeCss)
        : window.ShadyCSS
            ? (Cf(window.ShadyCSS), (window.ShadyCSS = void 0))
            : Cf(window.WebComponents && window.WebComponents.flags);
    var V = Bf;
    var Df =
        /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,
        Ef = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi,
    ...
    function Mf(a) {
        !a.__cssRules && a.textContent && (a.__cssRules = bf(a.textContent));
    ...
    function Lf(a, b, c, d) {
        if (a) {
            var e = !1,
                f = a.type;
            if (d && f === hf) {
                var g = a.selector.match(Hf);
                g && (window.matchMedia(g[1]).matches || (e = !0));
            }
            f === vf ? b(a) : c && f === tf ? c(a) : f === uf && (e = !0);
            if ((a = a.rules) && !e) {
                e = 0;
                f = a.length;
                for (var h; e < f && (h = a[e]); e++) Lf(h, b, c, d);
            }
        }
    }
    function Of(a, b, c, d) {
    ...
    function Pf(a, b, c) {
        ...
        Qf ? a.compareDocumentPosition(Qf) === Node.DOCUMENT_POSITION_PRECEDING && (Qf = a) : (Qf = a);
    }
    function Rf(a, b) {
        var c = a.indexOf("var(");
        if (-1 === c) return b(a, "", "", "");
    ...
    function Wf(a, b, c, d) {
        ...
        if ((b = "template" === b.localName ? (b.content || b.qb || b).childNodes : b.children || b.childNodes))
    ...
    function Xf(a, b, c) {
        if (b)
            if (a.classList)
                ...
                c
                    ? d && ((b = d.replace("style-scope", "").replace(b, "")), Sf(a, b))
                    : Sf(a, (d ? d + " " : "") + "style-scope " + b);
            }
    }
    function Zf(a, b, c) {
        var d = W,
            e = a.__cssBuild;
        U || "shady" === e ? (b = Kf(b, c)) : ((a = Tf(a)), (b = $f(d, b, a.is, a.Y, c) + "\n\n"));
        return b.trim();
    }
    function $f(a, b, c, d, e) {
        var f = ag(c, d);
        c = c ? bg + c : "";
        return Kf(b, function (b) {
    ...
    function cg(a, b, c, d, e) {
        ...
        if (!Nf(b)) {
            b = 0;
            for (var g = f.length, h; b < g && (h = f[b]); b++) f[b] = c.call(a, h, d, e);
        }
        return f.join(dg);
    }
    function eg(a) {
    ...
    Uf.prototype.b = function (a, b, c) {
        ...
        a = a.replace(ig, function (a, e, h) {
            d || ((a = jg(h, e, b, c)), (d = d || a.stop), (e = a.Va), (h = a.value));
            return e + h;
        });
        e && (a = eg(a));
        return a;
    ...
    ba.Object.defineProperties(Uf.prototype, {
        a: {
            configurable: !0,
            enumerable: !0,
            get: function () {
    ...
    function Cg(a) {
        if (!a.C) {
            var b = {},
                c = {};
            Dg(a, c) && ((b.L = c), (a.rules = null));
            b.cssText = a.parsedCssText.replace(If, "").replace(Df, "");
            a.C = b;
        }
    }
    function Dg(a, b) {
    ...
    function Eg(a, b, c) {
        b &&
            (b =
                0 <= b.indexOf(";")
                    ? Fg(a, b, c)
                    : Rf(b, function (b, e, f, g) {
                        if (!e) return b + g;
                        (e = Eg(a, c[e], c)) && "initial" !== e
        ...
        Lf(
            ...
            function (a) {
                ...
                b &&
                    ...
                    e &&
                    yg.call(b, e) &&
                    (Dg(a, c), (a = a.index), (e = parseInt(a / 32, 10)), (d[e] = (d[e] || 0) | (1 << a % 32)));
            },
            null,
            !0
        );
    ...
    function Hg(a, b, c, d) {
        ...
        if (b.C.L) {
            ...
            if (g || h)
                (c = e),
                    h && (b.G || (b.G = cg(W, b, W.b, a ? bg + a : "", e)), (c = b.G || e)),
                    d({ gb: c, ab: h, Db: g });
        }
    }
    function Ig(a, b) {
        ...
        Lf(
            ...
            function (b) {
                Hg(a, b, e, function (e) {
                    yg.call(a.rb || a, e.gb) && (e.ab ? Dg(b, c) : Dg(b, d));
                });
            },
            null,
            !0
    ...
    function Jg(a, b, c, d) {
        ...
        return Zf(b, e, function (b) {
            var e = "";
            b.C || Cg(b);
            b.C.cssText && (e = Fg(a, b.C.cssText, c));
            b.cssText = e;
            if (!U && !Nf(b) && b.cssText) {
                var k = (e = b.cssText);
                null == b.Ca && (b.Ca = Gf.test(e));
                if (b.Ca)
                    if (null == b.ga) {
                        b.ga = [];
                        for (var p in h) (k = h[p]), (k = k(e)), e !== k && ((e = k), b.ga.push(p));
                    } else {
                        for (p = 0; p < b.ga.length; ++p) (k = h[b.ga[p]]), (e = k(e));
                        k = e;
                    }
                b.cssText = k;
                b.G = b.G || b.selector;
                ...
                p = b.G.split(",");
                k = 0;
                for (var G = p.length, B; k < G && (B = p[k]); k++) p[k] = B.match(g) ? B.replace(f, e) : e + " " + B;
                b.selector = p.join(",");
            }
        });
    }
    ...
    function Mg(a, b) {
        var c = Ng,
            d = Mf(a);
        a.textContent = Kf(d, function (a) {
            var d = (a.cssText = a.parsedCssText);
            a.C && a.C.cssText && ((d = d.replace(xf, "").replace(yf, "")), (a.cssText = Fg(c, d, b)));
        });
    }
    ba.Object.defineProperties(Ag.prototype, {
        a: {
            configurable: !0,
            enumerable: !0,
            get: function () {
    ...
    if (Pg && !U) {
        ...
        Pg.define = function (a, b, c) {
            var d = document.createComment(" Shady DOM styles for " + a + " "),
                e = document.head;
            e.insertBefore(d, (Qf ? Qf.nextSibling : null) || e.firstChild);
            Qf = d;
            Og[a] = d;
            Qg.call(Pg, a, b, c);
        };
    ...
    Rg.prototype.fetch = function (a, b, c) {
        if ((a = this.cache[a]))
            ...
            if (c.target !== document.documentElement && c.target !== document.head)
                for (var d = 0; d < c.addedNodes.length; d++) {
                    ...
                    if (e.nodeType === Node.ELEMENT_NODE) {
                        ...
                        g = h;
                        h = g.indexOf(W.a);
                        if ((g = -1 < h ? g[h + 1] : "") && f === e.ownerDocument) Vf(e, g, !0);
                        else if (f.nodeType === Node.DOCUMENT_FRAGMENT_NODE && (f = f.host))
                            if (((f = Tf(f).is), g === f))
                                for (
                                    e = window.ShadyDOM.nativeMethods.querySelectorAll.call(e, ":not(." + W.a + ")"),
                                    f = 0;
                                    f < e.length;
                                    f++
                                )
                                    Xf(e[f], g);
                            else g && Vf(e, g, !0), Vf(e, f);
                    }
                }
        }
    }
    if (!U) {
        ...
        if (window.customElements && !window.customElements.polyfillWrapFlushCallback) Vg(document);
        else {
            var Wg = function () {
                Vg(document.body);
            };
        ...
        if (!a.B) {
            ...
            for (var f = a.content.querySelectorAll("style"), g = 0; g < f.length; g++) {
                ...
                if (h.hasAttribute("shady-unscoped")) {
                    if (!U) {
                        var k = h.textContent;
                        Jf.has(k) || (Jf.add(k), (k = h.cloneNode(!0)), document.head.appendChild(k));
                        h.parentNode.removeChild(h);
                    }
                } else e.push(h.textContent), h.parentNode.removeChild(h);
            }
            e = e.join("").trim();
            c = { is: b, extends: c, ob: d };
            dh(this);
            f = Ef.test(e) || Df.test(e);
            Ef.lastIndex = 0;
            Df.lastIndex = 0;
            e = bf(e);
            ...
            if (!d.length || V)
                (e = U ? a.content : null),
                    (b = Og[b]),
                    (f = Zf(c, a._styleAst)),
                    (b = f.length ? Of(f, c.is, e, b) : void 0),
                    (a.a = b);
            a.f = d;
        }
    };
        ...
        !a.b &&
            ...
            ((a.b = window.ShadyCSS.CustomStyleInterface),
                ...
                (a.b.validateCallback = function () {
                    requestAnimationFrame(function () {
                        (a.b.enqueued || a.B) && a.flushCustomStyles();
                    });
                }));
    }
    function dh(a) {
            ...
            if (this.b.enqueued) {
                if (V)
                    ...
                    for (fh(this, this.c, this.f), b = 0; b < a.length; b++)
                        (c = this.b.getStyleForCustomStyle(a[b])) && Mg(c, this.f.O);
                this.b.enqueued = !1;
                this.B && !V && this.styleDocument();
            }
        }
    };
    r.styleElement = function (a, b) {
        ...
        if (!d) {
            ...
            d = xg(a, new wg(g, f, h, e));
        }
        a !== this.c && (this.B = !0);
        b && ((d.U = d.U || {}), Object.assign(d.U, b));
        if (V) {
            if (d.U) {
                b = d.U;
                for (var k in b) null === k ? a.style.removeProperty(k) : a.style.setProperty(k, b[k]);
            }
            if (((k = Yg[c]) || a === this.c) && k && k.a && !ah(k)) {
                if (ah(k) || k._applyShimValidatingVersion !== k._applyShimNextVersion)
                    dh(this), this.a && this.a.transformRules(k._styleAst, c), (k.a.textContent = Zf(a, d.M)), bh(k);
                U && (c = a.shadowRoot) && (c.querySelector("style").textContent = Zf(a, d.M));
                d.M = k._styleAst;
            }
        } else if ((this.flush(), fh(this, a, d), d.ua && d.ua.length)) {
            c = d;
            k = Tf(a).is;
            d = (b = ch.fetch(k, c.O, c.ua)) ? b.styleElement : null;
            g = c.I;
            (h = b && b.I) || ((h = this.S[k] = (this.S[k] || 0) + 1), (h = k + "-" + h));
            c.I = h;
            h = c.I;
            e = Ng;
            e = d ? d.textContent || "" : Jg(e, a, c.O, h);
            f = X(a);
            var m = f.a;
            m && !U && m !== d && (m._useCount--, 0 >= m._useCount && m.parentNode && m.parentNode.removeChild(m));
            U
                ? f.a
                    ? ((f.a.textContent = e), (d = f.a))
                    : e && (d = Of(e, h, a.shadowRoot, f.b))
                : d
                    ? d.parentNode || (zg && -1 < e.indexOf("@media") && (d.textContent = e), Pf(d, null, f.b))
                    : e && (d = Of(e, h, null, f.b));
            ...
            U ||
                ((d = c.I),
                    ...
                    g && (f = e.replace(new RegExp("\\s*x-scope\\s*" + g + "\\s*", "g"), " ")),
                    (f += (f ? " " : "") + "x-scope " + d),
                    e !== f && Sf(a, f));
            b || ch.store(k, c.O, h, c.I);
        }
    };
    function gh(a, b) {
    ...
    function fh(a, b, c) {
        ...
        var e = Ig(b, c.M);
        b = Gg(d.M, b).L;
        Object.assign(a, e.Za, b, e.fb);
        b = c.U;
        for (var f in b) if ((e = b[f]) || 0 === e) a[f] = e;
        f = Ng;
        b = Object.getOwnPropertyNames(a);
        for (e = 0; e < b.length; e++) (d = b[e]), (a[d] = Eg(f, a[d], a));
        c.O = a;
    }
    ...
    Y.prototype.setElementClass = Y.prototype.hb;
    ...
    Y.prototype.styleAstToString = Y.prototype.ib;
    ...
    (function (a) {
            ...
            a: for (; (void 0 != a[A - 1] || 0 == A) && !this.i;) {
                ...
                switch (k) {
                    ...
                    case "relative or authority":
                        if ("/" == l && "/" == a[A + 1]) k = "authority ignore slashes";
                        else {
                            h("Expected /, got: " + l);
                            k = "relative";
                            continue;
                    ...
                    case "relative slash":
                        if ("/" == l || "\\" == l)
                            "\\" == l && h("\\ is an invalid code point."),
                                (k = "file" == this.h ? "file host" : "authority ignore slashes");
                        else {
                            ...
                            for (l = 0; l < q.length; l++)
                                (D = q[l]),
                                    "\t" == D || "\n" == D || "\r" == D
                                        ...
                                        : ":" == D && null === this.g
                                            ? (this.g = "")
                                            : ((D = c(D)), null !== this.g ? (this.g += D) : (this.u += D));
                            q = "";
                    ...
                    case "file host":
                        if (void 0 == l || "/" == l || "\\" == l || "?" == l || "#" == l) {
                            2 != q.length || !p.test(q[0]) || (":" != q[1] && "|" != q[1])
                                ? (0 != q.length && ((this.j = b.call(this, q)), (q = "")), (k = "relative path start"))
                                : (k = "relative path");
                            continue;
                    ...
                    case "relative path start":
                        ...
                        break;
                    case "relative path":
                        if (void 0 != l && "/" != l && "\\" != l && (e || ("?" != l && "#" != l)))
                            "\t" != l && "\n" != l && "\r" != l && (q += c(l));
                        else {
                            "\\" == l && h("\\ not allowed in relative path.");
                            if ((D = n[q.toLowerCase()])) q = D;
                            ".." == q
                                ...
                                : "." == q && "/" != l && "\\" != l
                                    ...
                                    ("file" == this.h &&
                                        ...
                                        this.l.push(q));
                            q = "";
                            "?" == l ? ((this.s = "?"), (k = "query")) : "#" == l && ((this.D = "#"), (k = "fragment"));
                        }
                        break;
                    case "query":
                        e || "#" != l
        ...
        if (!h) {
            ...
            g.prototype = {
                ...
                get href() {
                    if (this.i) return this.Ta;
                    var a = "";
                    if ("" != this.u || null != this.g) a = this.u + (null != this.g ? ":" + this.g : "") + "@";
                    return this.protocol + (this.F ? "//" + a + this.host : "") + this.pathname + this.s + this.D;
                },
                set href(a) {
                    f.call(this);
                    e.call(this, a);
                ...
                set host(a) {
                    !this.i && this.F && e.call(this, a, "host");
                },
                get hostname() {
                    return this.j;
                },
                set hostname(a) {
                    !this.i && this.F && e.call(this, a, "hostname");
                },
                get port() {
                    return this.o;
                },
                set port(a) {
                    !this.i && this.F && e.call(this, a, "port");
                },
                get pathname() {
                    return this.i ? "" : this.F ? "/" + this.l.join("/") : this.ra;
                },
                set pathname(a) {
                    !this.i && this.F && ((this.l = []), e.call(this, a, "relative path start"));
                },
                get search() {
                    return this.i || !this.s || "?" == this.s ? "" : this.s;
                },
                set search(a) {
                    !this.i && this.F && ((this.s = "?"), "?" == a[0] && (a = a.slice(1)), e.call(this, a, "query"));
                },
                get hash() {
                    return this.i || !this.D || "#" == this.D ? "" : this.D;
                },
                set hash(a) {
                    this.i || ((this.D = "#"), "#" == a[0] && (a = a.slice(1)), e.call(this, a, "fragment"));
                },
                get origin() {
                    var a;
    ...
    var jh = document.createElement("style");
    jh.textContent =
        "body {transition: opacity ease-in 0.2s; } \nbody[unresolved] {opacity: 0; display: block; overflow: hidden; position: relative; } \n";
    var kh = document.querySelector("head");
    kh.insertBefore(jh, kh.firstChild);
    var lh = window.customElements,
        mh = !1,
        nh = null;
    lh.polyfillWrapFlushCallback &&
        lh.polyfillWrapFlushCallback(function (a) {
            nh = a;
            mh && a();
        });
    function oh() {
    ...
    "complete" !== document.readyState
        ? (window.addEventListener("load", oh),
            window.addEventListener("DOMContentLoaded", function () {
                window.removeEventListener("load", oh);
                oh();
            }))
        : oh();
}).call(this);
