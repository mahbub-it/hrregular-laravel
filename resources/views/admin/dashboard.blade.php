...
<!-- Mirrored from demo.worksuite.biz/account/dashboard by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Mar 2026 03:04:29 GMT -->
<!-- Added by HTTrack -->
                ...
                <div class="row emp-dash-detail">
                    ...
                    <div class="col-xl-5 col-lg-12 col-md-12 e-d-info-notices">
                        <div class="row">
                                ...
                                <div class="card border-0 b-shadow-4 mb-3 e-d-info">
                                    <a href="1.html">
                                        <div class="card-horizontal align-items-center">
                                            <div class="card-img">
                                                <img class="" src="https://i.pravatar.cc/300?u=admin@example.com"
                                                    alt="Card image">
                                            </div>
                                            <div class="card-body border-0 pl-0">
                                                <h4 class="card-title text-dark f-18 f-w-500 mb-0">Rhoda Beatty</h4>
                                        ...
                                        <div class="d-flex flex-wrap justify-content-between">
                                            <span>
                                                ...
                                                <p class="mb-0 f-18 f-w-500">
                                                    <a href="tasks224d.html?assignee=me" class="text-dark">
                                                        1
                                                    </a>
                                                </p>
                                            </span>
                                            <span>
                                                <label class="f-12 text-dark-grey mb-12 " for="usr">
                                                    Projects </label>
                                                <p class="mb-0 f-18 f-w-500">
                                                    <a href="projects1ff2.html?assignee=me&amp;status=all"
                                                        class="text-dark">2</a>
                                                </p>
                                            </span>
                                            <span>
                                                <label class="f-12 text-dark-grey mb-12 " for="usr">
                                                    Open Tickets </label>
                                                <p class="mb-0 f-18 f-w-500">
                                                    <a href="ticketsa832.html?agent=me&amp;status=open"
                                                        class="text-dark">2</a>
                                                </p>
                                            </span>
                                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card bg-white border-0 b-shadow-4 mb-3">
                                    <div class="card-header bg-white border-0  d-flex justify-content-between pt-4">
                                        ...
                                        <button type="button" class="btn-primary rounded f-14 p-2" id="view-shifts">
                                            Employee Shift
                                        </button>

                                        <input type="search" class="autocomplete-password"
                                            style="opacity: 0;position: absolute;">
                                        <input type="password" class="autocomplete-password"
                                            style="opacity: 0;position: absolute;">
                                        <input type="email" name="f_email" class="autocomplete-password" readonly
                                            style="opacity: 0;position: absolute;">
                                        <input type="text" name="f_slack_username" class="autocomplete-password"
                                            readonly style="opacity: 0;position: absolute;">
                                        ...
                                        <table class="table" id="example">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-success"
                                                            style="background-color:#4d4c4c">Night Shift
                                                        </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-success"
                                                            style="background-color:#99C7F1">General Shift
                                                        </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-success"
                                                            style="background-color:#ff0000">Day Shift
                                                        </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pr-20 text-right">
                                                        <div class="task_view">
                                                            <a href="javascript:;" data-shift-schedule-id="14"
                                                                data-shift-schedule-date="2026-03-14" data-shift-id="3"
                                                                class="taskView border-right-0 request-shift-change f-11">Request
                                                                Change</a>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pr-20 text-right">
                                                        <div class="task_view">
                                                            <a href="javascript:;" data-shift-schedule-id="15"
                                                                data-shift-schedule-date="2026-03-15" data-shift-id="2"
                                                                class="taskView border-right-0 request-shift-change f-11">Request
                                                                Change</a>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pr-20 text-right">
                                                        <div class="task_view">
                                                            <a href="javascript:;" data-shift-schedule-id="16"
                                                                data-shift-schedule-date="2026-03-16" data-shift-id="2"
                                                                class="taskView border-right-0 request-shift-change f-11">Request
                                                                Change</a>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pr-20 text-right">
                                                        <div class="task_view">
                                                            <a href="javascript:;" data-shift-schedule-id="17"
                                                                data-shift-schedule-date="2026-03-17" data-shift-id="3"
                                                                class="taskView border-right-0 request-shift-change f-11">Request
                                                                Change</a>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pr-20 text-right">
                                                        <div class="task_view">
                                                            <a href="javascript:;" data-shift-schedule-id="18"
                                                                data-shift-schedule-date="2026-03-18" data-shift-id="2"
                                                                class="taskView border-right-0 request-shift-change f-11">Request
                                                                Change</a>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pr-20 text-right">
                                                        <div class="task_view">
                                                            <a href="javascript:;" data-shift-schedule-id="19"
                                                                data-shift-schedule-date="2026-03-19" data-shift-id="2"
                                                                class="taskView border-right-0 request-shift-change f-11">Request
                                                                Change</a>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pr-20 text-right">
                                                        <div class="task_view">
                                                            <a href="javascript:;" data-shift-schedule-id="20"
                                                                data-shift-schedule-date="2026-03-20" data-shift-id="3"
                                                                class="taskView border-right-0 request-shift-change f-11">Request
                                                                Change</a>
                                                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card bg-white border-0 b-shadow-4 e-d-info mb-2">
                                    <div class="card-header bg-white border-0  d-flex justify-content-between pt-4">
                                                ...
                                                <tr>
                                                    <td colspan="3" class="shadow-none">
                                                        <div
                                                            ...
                                                            <i class="fa fa-birthday-cake f-21 w-100"></i>
                            ...
                            <div class="col-sm-12">
                                <div class="card bg-white border-0 b-shadow-4 e-d-info mb-2">
                                    <div class="card-header bg-white border-0  d-flex justify-content-between pt-4">
                                        <h4 class="f-18 f-w-500 mb-0">Employee Appreciations</h4>
                                    ...
                                    <div class="card-body p-0 h-200">
                                        <table class="table appreciation-table" id="example">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center mw-250">

                                                            <a href="18.html" class="position-relative ">
                                                                <img src="https://i.pravatar.cc/300?u=zfriesen@example.net5"
                                                                    class="mr-2 taskEmployeeImg rounded-circle"
                                                                    alt="Alfreda Sipes" title="Alfreda Sipes">
                                                            </a>
                                                            <div class="media-body active text-truncate">

                                                                <h5 class="mb-0 f-12">
                                                                    <a href="18.html" class="text-darkest-grey ">Alfreda
                                                                        Sipes</a>
                                                                </h5>
                                                    ...
                                                    <td class="text-right pr-20">
                                                        <div class="d-flex justify-content-end" data-toggle="tooltip"
                                                            data-original-title="">
                                                            <div class="ml-1 f-12 mr-3">
                                                                <span class="font-weight-semibold">Best New
                                                                    Hire</span><br>
                                                                05-01-2026
                                                            </div>
                                                            <span
                                                                class="align-items-center d-inline-flex height-40 justify-content-center rounded width-40"
                                                                style="background-color: #7B1C2E20;">
                                                                <i class="bi bi-cup-hot f-15 text-white appreciation-icon"
                                                                    style="color: #7B1C2E  !important"></i>
                                                            </span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center mw-250">
                                                            ...
                                                            <a href="19.html" class="position-relative ">
                                                                <img src="https://i.pravatar.cc/300?u=garrett.runte@example.net0"
                                                                    class="mr-2 taskEmployeeImg rounded-circle"
                                                                    alt="Laurence Davis" title="Laurence Davis">
                                                            </a>
                                                            <div class="media-body active text-truncate">

                                                                <h5 class="mb-0 f-12">
                                                                    <a href="19.html"
                                                                        class="text-darkest-grey ">Laurence Davis</a>
                                                                </h5>
                                                                <p class="mb-0 f-12 text-dark-grey">
                                                                    Senior
                                                                </p>
                                                    ...
                                                    <td class="text-right pr-20">
                                                        <div class="d-flex justify-content-end" data-toggle="tooltip"
                                                            data-original-title="">
                                                            <div class="ml-1 f-12 mr-3">
                                                                <span class="font-weight-semibold">Best Customer
                                                                    Service</span><br>
                                                                05-01-2026
                                                            </div>
                                                            <span
                                                                class="align-items-center d-inline-flex height-40 justify-content-center rounded width-40"
                                                                style="background-color: #FF383820;">
                                                                <i class="bi bi-watch f-15 text-white appreciation-icon"
                                                                    style="color: #FF3838  !important"></i>
                                                            </span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center mw-250">
                                                            ...
                                                            <a href="15.html" class="position-relative ">
                                                                <img src="https://i.pravatar.cc/300?u=becker.delia@example.org7"
                                                                    class="mr-2 taskEmployeeImg rounded-circle"
                                                                    alt="Prof. Flo Rippin" title="Prof. Flo Rippin">
                                                            </a>
                                                            <div class="media-body active text-truncate">

                                                                <h5 class="mb-0 f-12">
                                                                    <a href="15.html" class="text-darkest-grey ">Prof.
                                                                        Flo Rippin</a>
                                                                </h5>
                                                                <p class="mb-0 f-12 text-dark-grey">
                                                                    Team Lead
                                                    ...
                                                    <td class="text-right pr-20">
                                                        <div class="d-flex justify-content-end" data-toggle="tooltip"
                                                            data-original-title="">
                                                            <div class="ml-1 f-12 mr-3">
                                                                <span class="font-weight-semibold">Best Technical
                                                                    Writer</span><br>
                                                                05-01-2026
                                                            </div>
                                                            <span
                                                                class="align-items-center d-inline-flex height-40 justify-content-center rounded width-40"
                                                                style="background-color: #7B1C2E20;">
                                                                <i class="bi bi-book f-15 text-white appreciation-icon"
                                                                    style="color: #7B1C2E  !important"></i>
                                                            </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right pr-20">
                                                        <div class="d-flex justify-content-end" data-toggle="tooltip"
                                                            data-original-title="">
                                                            <div class="ml-1 f-12 mr-3">
                                                                <span class="font-weight-semibold">Star Performer
                                                                    Award</span><br>
                                                                05-01-2026
                                                            </div>
                                                            <span
                                                                class="align-items-center d-inline-flex height-40 justify-content-center rounded width-40"
                                                                style="background-color: #282E3320;">
                                                                <i class="bi bi-hand-thumbs-up f-15 text-white appreciation-icon"
                                                                    style="color: #282E33  !important"></i>
                                                            </span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media align-items-center mw-250">
                                                            ...
                                                            <a href="1.html" class="position-relative ">
                                                                <img src="https://i.pravatar.cc/300?u=admin@example.com"
                                                                    class="mr-2 taskEmployeeImg rounded-circle"
                                                                    alt="Rhoda Beatty" title="Rhoda Beatty">
                                                            </a>
                                                            <div class="media-body active text-truncate">

                                                                <h5 class="mb-0 f-12">
                                                                    <a href="1.html" class="text-darkest-grey ">Rhoda
                                                                        Beatty <span
                                                    ...
                                                    <td class="text-right pr-20">
                                                        <div class="d-flex justify-content-end" data-toggle="tooltip"
                                                            data-original-title="">
                                                            <div class="ml-1 f-12 mr-3">
                                                                <span class="font-weight-semibold">Most Improved
                                                                    Employee</span><br>
                                                                05-01-2026
                                                            </div>
                                                            <span
                                                                class="align-items-center d-inline-flex height-40 justify-content-center rounded width-40"
                                                                style="background-color: #495E6720;">
                                                                <i class="bi bi-book f-15 text-white appreciation-icon"
                                                                    style="color: #495E67  !important"></i>
                                                            </span>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="3" class="shadow-none">
                                                        <div
                                                            class="align-items-center d-flex flex-column text-lightest p-20 w-100">
                                                            <i class="fa fa-plane-departure f-21 w-100"></i>
                            ...
                            <div class="col-sm-12">
                                <div class="card bg-white border-0 b-shadow-4 e-d-info mb-2">
                                    <div class="card-header bg-white border-0  d-flex justify-content-between pt-4">
                                        <h4 class="f-18 f-w-500 mb-0">On Work From Home Today</h4>
                                    ...
                                    <div class="card-body p-0 ">
                                        <div class="row pr-20 ml-2">
                                            ...
                                            <div class="align-items-center d-flex flex-column text-lightest p-20 w-100">
                                                <i class="fa fa-home f-21 w-100"></i>
                            ...
                            <div class="col-sm-12">
                                <div class="card bg-white border-0 b-shadow-4 e-d-info">
                                    <div class="card-header bg-white border-0  d-flex justify-content-between pt-4">
                                        <h4 class="f-18 f-w-500 mb-0">Today's Joinings & Work Anniversary</h4>
                            ...
                            <div class="col-sm-12 mt-2">
                                <div class="card bg-white border-0 b-shadow-4 e-d-info mb-2">
                                    <div class="card-header bg-white border-0  d-flex justify-content-between pt-4">
                                        <h4 class="f-18 f-w-500 mb-0">Notice Period Duration</h4>
                                        ...
                                        <table class="table" id="example">
                                            <tbody>
                                                <span class="shadow-none">
                                                    <div
                                                        class="align-items-center d-flex flex-column text-lightest p-20 w-100">
                                                        <i class="fa fa-list f-21 w-100"></i>
                            ...
                            <div class="col-sm-12">
                                <div class="card bg-white border-0 b-shadow-4 e-d-info mb-2">
                                    <div class="card-header bg-white border-0  d-flex justify-content-between pt-4">
                                        <h4 class="f-18 f-w-500 mb-0">Probation Date</h4>
                            ...
                            <div class="col-sm-12 mt-2">
                                <div class="card bg-white border-0 b-shadow-4 e-d-info mb-2">
                                    <div class="card-header bg-white border-0  d-flex justify-content-between pt-4">
                                        <h4 class="f-18 f-w-500 mb-0">Internship Date</h4>
                            ...
                            <div class="col-sm-12 mt-2">
                                <div class="card bg-white border-0 b-shadow-4 e-d-info mb-2">
                                    <div class="card-header bg-white border-0  d-flex justify-content-between pt-4">
                                        <h4 class="f-18 f-w-500 mb-0">Contract Date</h4>
                    ...
                    <div class="col-xl-7 col-lg-12 col-md-12 e-d-tasks-projects-events">
                            ...
                            <div class="col-md-6 mb-3">
                                <div
                                    ...
                                    <div class="d-block ">
                                        ...
                                        <div class="d-flex">
                                            <a href="tasks224d.html?assignee=me">
                                                <p class="mb-0 f-21 font-weight-bold text-blue d-grid mr-5">
                                                    1<span class="f-12 font-weight-normal text-lightest">
                                                        Pending </span>
                                                </p>
                                            </a>
                                            <a href="tasks9377.html?assignee=me&amp;overdue=yes">
                            ...
                            <div class="col-md-6 mb-3">
                                <div
                                    ...
                                    <div class="d-block ">
                                        ...
                                        <div class="d-flex">
                                            <a href="projects9020.html?assignee=me&amp;status=in%20progress">
                                                <p class="mb-0 f-21 font-weight-bold text-blue d-grid mr-5">
                                                    2<span class="f-12 font-weight-normal text-lightest">In
                                                        Progress</span>
                                                </p>
                                            </a>

                                            <a href="projects4bbf.html?assignee=me&amp;status=overdue">
                                                <p class="mb-0 f-21 font-weight-bold text-red d-grid">
                                                    2<span class="f-12 font-weight-normal text-lightest">Overdue</span>
                                                </p>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-block  w-100">
                                        ...
                                        <div id="weekly-timelogs">
                                            <nav class="mb-3">
                                                <ul class="pagination pagination-sm week-pagination">
                                                    <li class="page-item week-timelog-day" data-toggle="tooltip"
                                                        data-original-title="09-03-2026" data-date="2026-03-09">
                                                        <a class="page-link" href="javascript:;">Mo</a>
                                                    </li>
                                                    <li class="page-item week-timelog-day" data-toggle="tooltip"
                                                        data-original-title="10-03-2026" data-date="2026-03-10">
                                                        <a class="page-link" href="javascript:;">Tu</a>
                                                    </li>
                                                    <li class="page-item week-timelog-day" data-toggle="tooltip"
                                                        data-original-title="11-03-2026" data-date="2026-03-11">
                                                        <a class="page-link" href="javascript:;">We</a>
                                                    </li>
                                                    <li class="page-item week-timelog-day" data-toggle="tooltip"
                                                        data-original-title="12-03-2026" data-date="2026-03-12">
                                                        <a class="page-link" href="javascript:;">Th</a>
                                                    </li>
                                                    <li class="page-item week-timelog-day active" data-toggle="tooltip"
                                                        data-original-title="13-03-2026" data-date="2026-03-13">
                                                        <a class="page-link" href="javascript:;">Fr</a>
                                                    </li>
                                                    <li class="page-item week-timelog-day" data-toggle="tooltip"
                                                        data-original-title="14-03-2026" data-date="2026-03-14">
                                                        <a class="page-link" href="javascript:;">Sa</a>
                                                    </li>
                                                    <li class="page-item week-timelog-day" data-toggle="tooltip"
                                                        data-original-title="15-03-2026" data-date="2026-03-15">
                                            ...
                                            <div class="progress" style="height: 20px;">
                                                ...
                                                <div class="progress-bar bg-grey" role="progressbar" style="width: 100%"
                                ...
                                <div class="bg-white p-20 rounded b-shadow-4">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h5 class="f-15 f-w-500 mb-0 text-darkest-grey">
                                            <i class="fa fa-file-alt text-primary mr-2"></i>Document Expiries
                                        </h5>
                                        <span class="badge badge-primary f-10">0 documents</span>
                                    </div>

                                    <div class="document-list" style="max-height: 250px; overflow-y: auto;">
                                        <div class="text-center py-4">
                                            <i class="fa fa-file-alt text-lightest f-24 mb-2"></i>
                                            <p class="mb-0 f-12 text-lightest">No upcoming document expiries.</p>
                                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card border-0 b-shadow-4 mb-3 e-d-info">
                                    <div class="card bg-white border-0 b-shadow-4">
                                        <div class="card-header bg-white border-0  d-flex justify-content-between pt-4">
                                            <h4 class="f-18 f-w-500 mb-0">My Tasks</h4>
                                            ...
                                            <table class="table" id="example">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="pl-20">
                                                            <a href="40.html"
                                                                class="openRightModal f-12 mb-1 text-darkest-grey">#EMA-40</a>
                                                            ...
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <h5 class="f-12 mb-1 text-darkest-grey"><a
                                                                            href="40.html" class="openRightModal">There
                                                                            was nothing.</a>
                                                                    </h5>
                                                                    <p class="mb-0">
                                                                    </p>
                                        ...
                                        <div class="card-body p-0 h-200">
                                            <table class="table" id="example">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="pl-20">
                                                            <a href="6.html" class="text-darkest-grey">#6</a>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <h5 class="f-12 mb-1 text-darkest-grey">
                                                                        <a href="6.html">Esse est qui natus.</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="pl-20">
                                                            <a href="5.html" class="text-darkest-grey">#5</a>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <h5 class="f-12 mb-1 text-darkest-grey">
                                                                        <a href="5.html">Quia sed soluta et.</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="pl-20">
                                                            <a href="4.html" class="text-darkest-grey">#4</a>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <h5 class="f-12 mb-1 text-darkest-grey">
                                                                        <a href="4.html">Corrupti voluptatem.</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="pl-20">
                                                            <a href="3.html" class="text-darkest-grey">#3</a>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <h5 class="f-12 mb-1 text-darkest-grey">
                                                                        <a href="3.html">Reprehenderit.</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="pl-20">
                                                            <a href="1-2.html" class="text-darkest-grey">#1</a>
                                                        </td>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <h5 class="f-12 mb-1 text-darkest-grey">
                                                                        <a href="1-2.html">Ab qui sint sed id.</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card bg-white border-0 b-shadow-4">
                                    <div class="card-header bg-white border-0  d-flex justify-content-between pt-4">
                                        <h4 class="f-18 f-w-500 mb-0">My Calendar</h4>

                                        <div class="dropdown ml-auto calendar-action">
                                            <button id="event-btn"
                                                class="btn btn-lg f-14 p-0 text-lightest  rounded  dropdown-toggle cal-event"
                                            ...
                                            <div id="cal-drop"
                                                ...
                                                <div class="custom-control custom-checkbox cal-filter">
                                                    ...
                                                    <label
                                                        class="form-check-label form_custom_label text-dark-grey pl-2 mr-3 justify-content-start cursor-pointer checkmark-20 pt-2 text-wrap"
                                                        for="customCheck3">Holiday</label>
                                                </div>
                                                <div class="custom-control custom-checkbox cal-filter">
                                                    ...
                                                    <label
                                                        class="form-check-label form_custom_label text-dark-grey pl-2 mr-3 justify-content-start cursor-pointer checkmark-20 pt-2 text-wrap"
                                                        for="customCheck4">Tickets</label>
                                                </div>
                                                <div class="custom-control custom-checkbox cal-filter">
                                                    <input type="checkbox" value="leaves"
                                                        class="form-check-input filter-check" name="calendar[]"
                                                        id="customCheck5" checked>
                                                    <label
                                                        class="form-check-label form_custom_label text-dark-grey pl-2 mr-3 justify-content-start cursor-pointer checkmark-20 pt-2 text-wrap"
                                                        for="customCheck5">Leaves</label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="b-shadow-4 cal-info scroll ps" data-menu-vertical="1"
                                        ...
                                        <div class="card border-0 b-shadow-4 p-20 rounded-0">
                                            <div class="card-horizontal">
                                                <div class="card-header m-0 p-0 bg-white rounded">
                                                    <span class="f-12 p-1 ">Mar</span>
                                                    <span class="f-13 f-w-500 rounded-bottom">19</span>
                                                </div>
                                                <div class="card-body border-0 p-0 ml-3">
                                                    <h4 class="card-title f-14 font-weight-normal mb-0">
                                                        <a href="2.html" class="openRightModal text-darkest-grey">She
                                                            hastily put down her flamingo, and began staring at the
                                                            door--I.</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card border-0 b-shadow-4 p-20 rounded-0">
                                            <div class="card-horizontal">
                                                ...
                                                <div class="card-body border-0 p-0 ml-3">
                                                    <h4 class="card-title f-14 font-weight-normal mb-0">
                                                        <a href="3-2.html"
                                                            class="openRightModal text-darkest-grey">There was exactly
                                                            one a-piece all round. (It was this last remark.</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        </div><!-- card end -->
                                        <div class="card border-0 b-shadow-4 p-20 rounded-0">
                                            <div class="card-horizontal">
                                                <div class="card-header m-0 p-0 bg-white rounded">
                                                    <span class="f-12 p-1 ">Mar</span>
                                                    <span class="f-13 f-w-500 rounded-bottom">13</span>
                                                </div>
                                                <div class="card-body border-0 p-0 ml-3">
                                                    <h4 class="card-title f-14 font-weight-normal mb-0">
                                                        <a href="1-3.html" class="openRightModal text-darkest-grey">So
                                                            she was beginning to see if she did not at all for any.</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        </div><!-- card end -->
                                        <div class="card border-0 b-shadow-4 p-20 rounded-0">
                                            <div class="card-horizontal">
                                                <div class="card-header m-0 p-0 bg-white rounded">
                                                    <span class="f-12 p-1 ">Mar</span>
                                                    <span class="f-13 f-w-500 rounded-bottom">09</span>
                                                </div>
                                                <div class="card-body border-0 p-0 ml-3">
                                                    <h4 class="card-title f-14 font-weight-normal mb-0">
                                                        <a href="6-2.html"
                                                            class="openRightModal text-darkest-grey">March Hare. Visit
                                                            either you like: they&#039;re both mad.&#039; &#039;But I
                                                            don&#039;t.</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card border-0 b-shadow-4 p-20 rounded-0">
                                            <div class="card-horizontal">
                                                <div class="card-header m-0 p-0 bg-white rounded">
                                                    <span class="f-12 p-1 ">Feb</span>
                                                    <span class="f-13 f-w-500 rounded-bottom">25</span>
                                                </div>
                                                <div class="card-body border-0 p-0 ml-3">
                                                    <h4 class="card-title f-14 font-weight-normal mb-0">
                                                        <a href="8.html" class="openRightModal text-darkest-grey">Pray
                                                            how did you call him Tortoise--&#039; &#039;Why did they
                                                            draw?&#039; said.</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card border-0 b-shadow-4 p-20 rounded-0">
                                            <div class="card-horizontal">
                                                <div class="card-header m-0 p-0 bg-white rounded">
                                                    <span class="f-12 p-1 ">Feb</span>
                                                    <span class="f-13 f-w-500 rounded-bottom">16</span>
                                                </div>
                                                <div class="card-body border-0 p-0 ml-3">
                                                    <h4 class="card-title f-14 font-weight-normal mb-0">
                                                        <a href="7.html" class="openRightModal text-darkest-grey">And
                                                            yet I wish you could keep it to make it stop. &#039;Well,
                                                            I&#039;d hardly.</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card border-0 b-shadow-4 p-20 rounded-0">
                                            <div class="card-horizontal">
                                                ...
                                                <div class="card-body border-0 p-0 ml-3">
                                                    <h4 class="card-title f-14 font-weight-normal mb-0">
                                                        <a href="4-2.html"
                                                            class="openRightModal text-darkest-grey">King:
                                                            &#039;however, it may kiss my hand if it makes rather a
                                                            handsome.</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card border-0 b-shadow-4 p-20 rounded-0">
                                            <div class="card-horizontal">
                                                <div class="card-header m-0 p-0 bg-white rounded">
                                                    <span class="f-12 p-1 ">Feb</span>
                                                    <span class="f-13 f-w-500 rounded-bottom">11</span>
                                                </div>
                                                <div class="card-body border-0 p-0 ml-3">
                                                    <h4 class="card-title f-14 font-weight-normal mb-0">
                                                        <a href="5-2.html"
                                                            class="openRightModal text-darkest-grey">Caterpillar seemed
                                                            to be true): If she should push the matter with.</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        </div><!-- card end -->
